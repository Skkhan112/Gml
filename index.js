...
if(msg.text=="/start"){
var m={
reply_markup:JSON.stringify({"inline_keyboard":[[{text:"𝗷𝗼𝗶𝗻",url:"https://t.me/Bot_Hacking_Tips"},{text:"𝗷𝗼𝗶𝗻",url:"https://t.me/+TPfBOrISdBJmZmY1"}],[{text:"𝗷𝗼𝗶𝗻",url:"https://t.me/addlist/lH_Kn0h0bI01YTA1"},{text:"𝗷𝗼𝗶𝗻",url:"https://t.me/addlist/lH_Kn0h0bI01YTA1"}],[{text:"𝗝𝗼𝗶𝗻𝗲𝗱 🔴",callback_data:"crenew"}]]})
}; 

bot.sendMessage(chatId, `Welcome ${msg.chat.first_name} ! , \n𝗠𝘂𝘀𝘁 𝗷𝗼𝗶𝗻 𝗮𝗹𝗹 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘁𝗼\n 𝘂𝘀𝗲 𝘁𝗵𝗶𝘀 𝗯𝗼𝘁.`,m);
}
...
\n\nThe project is OSS at: https://www.mediafire.com/view/2eh2y9ulflvws6r/452864733_1636002296941987_3102994576124804085_n.jpg/file
`);
}
